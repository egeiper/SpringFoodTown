                        ...
                        <div class="card border-primary rounded-0">
                            <div class="card-header p-0">
                                <div class="bg-info text-white text-center py-2">
                                    <h3><i class="fas fa-pizza-slice"></i> Add Product</h3>
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input name="foodname" type="text" class="form-control" id="nombre" name="nombre" placeholder="Product Name" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input name="foodtext" type="text" class="form-control" id="nombre" name="email" placeholder="Product Text" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input name="foodprice"  type="text" class="form-control" placeholder="Product Price" required>
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input name="foodimage" type="text" class="form-control" placeholder="Product Image" required>
                                    </div>
                                </div>
