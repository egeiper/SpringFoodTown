    ...
    <table class="table table-bordered shop-cart margin-bottom-50">
      <thead>
         <tr>
            ...
            <th class="product-name text-center">Food ID</th>
            <th class="product-price text-center">Food Name</th>
              <th class="product-price text-center">Food Text</th>
                <th class="product-price text-center">FoodPrice</th>
           <th class="product-price text-center">Food Image</th>
...
<c:if test="${not empty productlist }">
         ...
         <tr class="cart_item">
            ...
            <td class="product-name"><h5>${item.foodid }</h5></td>
            <td class="product-price"> <span class="Price-amount">${item.foodname }</span></td>
             <td class="product-price"> <span class="Price-amount">${item.foodtext }</span></td>
              <td class="product-price"> <span class="Price-amount">$${item.foodprice }</span></td>
              <td class="product-price"> <span class="Price-amount"><img src="${item.foodimage }" width=180px height=150px></span></td>
           <td>
                      	<a href='<s:url value="/admin/deleteproduct/${ item.foodid }"></s:url>' style="font-size: 13px" class="btn btn-danger"  >Delete</a>
