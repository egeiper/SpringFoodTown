...
<c:if test="${not empty messagelist }">
         ...
         <tr class="cart_item">
            ...
            <td class="product-price"> <span class="Price-amount">${item.namesurname }</span></td>
             <td class="product-price"> <span class="Price-amount">${item.mail }</span></td>
              <td class="product-price"> <span class="Price-amount">${item.message }</span></td>
